...
import com.dtflys.forest.test.http.client.PatchClient;
 ...
 */
public class TestPatchClient extends ForestClientTest {
    ...
    public TestPatchClient(String backend, String jsonConverter) {
